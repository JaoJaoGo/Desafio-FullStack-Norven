...
class EntradaModel(settings.DBBaseModel):
    ...
    data_entrada: Mapped[datetime] = mapped_column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP"))
    ...
    tipo_entrada: Mapped[str] = mapped_column(String(30), nullable=False)
    ...
    usuario: Mapped["UsuarioModel"] = relationship("UsuarioModel", back_populates="entradas")

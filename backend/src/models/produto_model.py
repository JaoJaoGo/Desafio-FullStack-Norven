...
from sqlalchemy import Boolean, DateTime, ForeignKey, Index, Numeric, String, Text, text, func, CheckConstraint, Integer
...
class ProdutoModel(settings.DBBaseModel):
    ...
    eh_perecivel: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default=text("false"))

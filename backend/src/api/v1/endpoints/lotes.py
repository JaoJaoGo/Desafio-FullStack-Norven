...
from schemas.lote_schema import LoteCreateSchema, LoteFilterSchema, LoteListResponseSchema, LoteResponseSchema, LoteUpdateSchema
...
@router.patch('/{lote_id}', response_model=LoteResponseSchema)
async def update_lote(lote_id: int, data: LoteUpdateSchema, db: AsyncSession = Depends(get_session)):
    return await LoteController.update(db, lote_id, data)